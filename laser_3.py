...
cap = cv2.VideoCapture('laser3.3gp')
...
while(cap.isOpened()):
    ...
    resized =  cv2.resize(h, (800, 400), interpolation = cv2.INTER_AREA)
    resized1 =  cv2.resize(s, (800, 400), interpolation = cv2.INTER_AREA)
    resized2 =  cv2.resize(v, (800, 400), interpolation = cv2.INTER_AREA)
    #resized2 =  cv2.resize(resultRed, (800, 400), interpolation = cv2.INTER_AREA)
    cv2.imshow('h',resized)
    cv2.imshow('s',resized1)
    cv2.imshow('v',resized2)
